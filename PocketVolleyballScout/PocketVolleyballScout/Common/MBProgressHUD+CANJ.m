...
@implementation MBProgressHUD (CANJ)
#pragma mark 显示信息
+ (void)CAshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)CAshowError:(NSString *)error toView:(UIView *)view{
    [self CAshow:error icon:@"error.png" view:view];
}

+ (void)CAshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self CAshow:success icon:@"success.png" view:view];
}
...
{
    [self CAshowSuccess:success toView:nil];
}

+ (void)CAshowError:(NSString *)error
{
    [self CAshowError:error toView:nil];
}

+ (void)CAshowReminderText:(NSString *)reminderText {
    [self CAshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self CAshowMessage:message toView:nil];
}
