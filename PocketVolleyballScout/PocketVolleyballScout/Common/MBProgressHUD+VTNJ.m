...
@implementation MBProgressHUD (VTNJ)
#pragma mark 显示信息
+ (void)VTshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)VTshowError:(NSString *)error toView:(UIView *)view{
    [self VTshow:error icon:@"error.png" view:view];
}

+ (void)VTshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self VTshow:success icon:@"success.png" view:view];
}
...
{
    [self VTshowSuccess:success toView:nil];
}

+ (void)VTshowError:(NSString *)error
{
    [self VTshowError:error toView:nil];
}

+ (void)VTshowReminderText:(NSString *)reminderText {
    [self VTshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self VTshowMessage:message toView:nil];
}
