...
@implementation MBProgressHUD (CVSNJ)
#pragma mark 显示信息
+ (void)CVSshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)CVSshowError:(NSString *)error toView:(UIView *)view{
    [self CVSshow:error icon:@"error.png" view:view];
}

+ (void)CVSshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self CVSshow:success icon:@"success.png" view:view];
}
...
{
    [self CVSshowSuccess:success toView:nil];
}

+ (void)CVSshowError:(NSString *)error
{
    [self CVSshowError:error toView:nil];
}

+ (void)CVSshowReminderText:(NSString *)reminderText {
    [self CVSshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self CVSshowMessage:message toView:nil];
}
