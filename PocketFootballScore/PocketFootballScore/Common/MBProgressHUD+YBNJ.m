...
@implementation MBProgressHUD (YBNJ)
#pragma mark 显示信息
+ (void)YBshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)YBshowError:(NSString *)error toView:(UIView *)view{
    [self YBshow:error icon:@"error.png" view:view];
}

+ (void)YBshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self YBshow:success icon:@"success.png" view:view];
}
...
{
    [self YBshowSuccess:success toView:nil];
}

+ (void)YBshowError:(NSString *)error
{
    [self YBshowError:error toView:nil];
}

+ (void)YBshowReminderText:(NSString *)reminderText {
    [self YBshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self YBshowMessage:message toView:nil];
}
