...
@implementation MBProgressHUD (GFNJ)
#pragma mark 显示信息
+ (void)GFshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)GFshowError:(NSString *)error toView:(UIView *)view{
    [self GFshow:error icon:@"error.png" view:view];
}

+ (void)GFshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self GFshow:success icon:@"success.png" view:view];
}
...
{
    [self GFshowSuccess:success toView:nil];
}

+ (void)GFshowError:(NSString *)error
{
    [self GFshowError:error toView:nil];
}

+ (void)GFshowReminderText:(NSString *)reminderText {
    [self GFshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self GFshowMessage:message toView:nil];
}
