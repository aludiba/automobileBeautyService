...
@interface AKSetTableViewCell()
@property(nonatomic, strong)UILabel *titleLbl;
@property(nonatomic, strong)UILabel *contentLbl;
@property(nonatomic, strong)UIImageView *arrowImgView;
@end
@implementation AKSetTableViewCell
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        self.contentView.backgroundColor = AKH_Color(244, 245, 246, 1);
        ...
        [self.titleLbl mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.width.mas_equalTo(AKWIDTH * 0.5 - 20);
        ...
        [self.contentLbl mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.centerY.equalTo(self.contentView);
            make.width.mas_equalTo(AKWIDTH * 0.5 - 5 - 22 - 15);
            make.height.mas_equalTo(16);
        }];
    }
    return self;
}
- (void)setModel:(AKSetViewModel *)model{
    _model = model;
...
- (UIImageView *)arrowImgView{
    if (!_arrowImgView) {
        _arrowImgView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"AK_arrow_right"]];
    }
