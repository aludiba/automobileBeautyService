...
@implementation MBProgressHUD (PWNJ)
#pragma mark 显示信息
+ (void)PWshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)PWshowError:(NSString *)error toView:(UIView *)view{
    [self PWshow:error icon:@"error.png" view:view];
}

+ (void)PWshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self PWshow:success icon:@"success.png" view:view];
}
...
{
    [self PWshowSuccess:success toView:nil];
}

+ (void)PWshowError:(NSString *)error
{
    [self PWshowError:error toView:nil];
}

+ (void)PWshowReminderText:(NSString *)reminderText {
    [self PWshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self PWshowMessage:message toView:nil];
}
