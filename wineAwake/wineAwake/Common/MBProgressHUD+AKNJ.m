...
@implementation MBProgressHUD (AKNJ)
#pragma mark 显示信息
+ (void)AKshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)AKshowError:(NSString *)error toView:(UIView *)view{
    [self AKshow:error icon:@"error.png" view:view];
}

+ (void)AKshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self AKshow:success icon:@"success.png" view:view];
}
...
{
    [self AKshowSuccess:success toView:nil];
}

+ (void)AKshowError:(NSString *)error
{
    [self AKshowError:error toView:nil];
}

+ (void)AKshowReminderText:(NSString *)reminderText {
    [self AKshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self AKshowMessage:message toView:nil];
}
