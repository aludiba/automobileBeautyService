//
//  WADrinkingPlanSaveTableViewCell.m
//  wineAwake
//
...
@interface WADrinkingPlanSaveTableViewCell()
@property(nonatomic, strong)UIButton *saveButton;//保存按钮
@end
@implementation WADrinkingPlanSaveTableViewCell
...
- (void)btnClick{
    if (self.WADrinkingPlanSaveB) {
        self.WADrinkingPlanSaveB(self);
    }
}
#pragma mark - 属性懒加载
- (UIButton *)saveButton{
