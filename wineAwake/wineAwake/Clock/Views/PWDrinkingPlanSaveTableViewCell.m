//
//  PWDrinkingPlanSaveTableViewCell.m
//  wineAwake
//
...
@interface PWDrinkingPlanSaveTableViewCell()
@property(nonatomic, strong)UIButton *saveButton;//保存按钮
@end
@implementation PWDrinkingPlanSaveTableViewCell
...
- (void)btnClick{
    if (self.PWDrinkingPlanSaveB) {
        self.PWDrinkingPlanSaveB(self);
    }
}
#pragma mark - 属性懒加载
- (UIButton *)saveButton{
