//
//  AKDrinkingPlanSaveTableViewCell.m
//  wineAwake
//
...
@interface AKDrinkingPlanSaveTableViewCell()
@property(nonatomic, strong)UIButton *saveButton;//保存按钮
@end
@implementation AKDrinkingPlanSaveTableViewCell
...
- (void)btnClick{
    if (self.AKDrinkingPlanSaveB) {
        self.AKDrinkingPlanSaveB(self);
    }
}
#pragma mark - 属性懒加载
- (UIButton *)saveButton{
