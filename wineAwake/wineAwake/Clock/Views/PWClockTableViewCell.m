...
@interface PWClockTableViewCell()
...
@end
@implementation PWClockTableViewCell
...
- (void)setModel:(PWDrinkingPlanSaveModel *)model{
    _model = model;
...
- (void)btnClick:(UIButton *)sender{
    ...
    if (self.PWClockCellB) {
        self.PWClockCellB(self);
    }
}
#pragma mark - 属性懒加载
- (UILabel *)remindLabel{
