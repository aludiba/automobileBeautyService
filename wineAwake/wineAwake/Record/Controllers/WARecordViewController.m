...
@interface WARecordViewController ()<JTCalendarDelegate>{
...
@implementation WARecordViewController
...
- (void)createRandomEvents{
    ...
    for(int i = 0; i < 30; ++i){
        ...
        NSString *key = [WAUIUtilities WAformattedTimeStringWithDate:randomDate format:@"yyyy-MM-dd"];
...
- (BOOL)haveEventForDay:(NSDate *)date{
    NSString *key = [WAUIUtilities WAformattedTimeStringWithDate:date format:@"yyyy-MM-dd"];
