...
@interface WAClockRecordTableViewCell()
@property(nonatomic, strong)UILabel *titleLbl;
@property(nonatomic, strong)UILabel *contentLbl;
@end
@implementation WAClockRecordTableViewCell
...
- (void)setModel:(WAClockRecordModel *)model{
    _model = model;
    ...
    CGSize size = [self.contentLbl sizeThatFits:CGSizeMake(WAWIDTH - 32 - 100 - 10, MAXFLOAT)];
