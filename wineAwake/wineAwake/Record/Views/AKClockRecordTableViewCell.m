...
@interface AKClockRecordTableViewCell()
@property(nonatomic, strong)UILabel *titleLbl;
@property(nonatomic, strong)UILabel *contentLbl;
@end
@implementation AKClockRecordTableViewCell
...
- (void)setModel:(AKClockRecordModel *)model{
    _model = model;
    ...
    CGSize size = [self.contentLbl sizeThatFits:CGSizeMake(AKWIDTH - 32 - 100 - 10, MAXFLOAT)];
