...
@implementation BMUIUtilities

+ (NSString *)BMformattedStringFromTimeString:(NSString *)originalString originalFormat:(NSString *)originalFormat targetFormat:(NSString *)targetFormat {
...
+ (NSString *)BMnonnullStringForString:(NSString *)originalString withPlaceholder:(NSString *)placeholder {
...
+ (NSString *)BMfilterHTMLTag:(NSString *)originalHTMLString {
...
+ (NSString *)BMunescapedHTMLString:(NSString *)originalHTMLString {
