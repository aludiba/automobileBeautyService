...
@implementation MBProgressHUD (PVYWKNJ)
#pragma mark 显示信息
+ (void)PVYWKshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)PVYWKshowError:(NSString *)error toView:(UIView *)view{
    [self PVYWKshow:error icon:@"error.png" view:view];
}

+ (void)PVYWKshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self PVYWKshow:success icon:@"success.png" view:view];
}
...
{
    [self PVYWKshowSuccess:success toView:nil];
}

+ (void)PVYWKshowError:(NSString *)error
{
    [self PVYWKshowError:error toView:nil];
}

+ (void)PVYWKshowReminderText:(NSString *)reminderText {
    [self PVYWKshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self PVYWKshowMessage:message toView:nil];
}
