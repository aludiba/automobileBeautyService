...
@implementation MBProgressHUD (ALNJ)
#pragma mark 显示信息
+ (void)ALshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)ALshowError:(NSString *)error toView:(UIView *)view{
    [self ALshow:error icon:@"error.png" view:view];
}

+ (void)ALshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self ALshow:success icon:@"success.png" view:view];
}
...
{
    [self ALshowSuccess:success toView:nil];
}

+ (void)ALshowError:(NSString *)error
{
    [self ALshowError:error toView:nil];
}

+ (void)ALshowReminderText:(NSString *)reminderText {
    [self ALshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self ALshowMessage:message toView:nil];
}
