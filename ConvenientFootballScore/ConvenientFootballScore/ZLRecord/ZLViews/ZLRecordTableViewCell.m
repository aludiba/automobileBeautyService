...
@property(nonatomic, strong)UIView *ZLBottomLine;
...
- (void)ZLSetContentView{
    ...
    [self.ZLBackView addSubview:self.ZLBottomLine];
    ...
    [self.ZLVSLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(self.ZLRightNameLabel);
        make.centerX.equalTo(self.ZLBackView);
    ...
    [self.ZLBottomLine mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.ZLLeftScoreLabel.mas_bottom).offset(20);
        make.leading.equalTo(self.ZLBackView).offset(16);
        make.height.mas_equalTo(1);
        make.trailing.equalTo(self.ZLBackView);
        make.bottom.equalTo(self.ZLBackView);
    }];
}
...
- (UILabel *)ZLTitleLabel{
    if (!_ZLTitleLabel) {
        ...
        _ZLTitleLabel.textColor = [UIColor systemGreenColor];
        _ZLTitleLabel.font = [UIFont boldSystemFontOfSize:35];
...
- (UILabel *)ZLEndTimeLabel{
    if (!_ZLEndTimeLabel) {
        ...
        _ZLEndTimeLabel.textColor = [UIColor systemGreenColor];
...
- (UILabel *)ZLElapsedTimeLabel{
    if (!_ZLElapsedTimeLabel) {
        ...
        _ZLElapsedTimeLabel.textColor = [UIColor systemGreenColor];
...
- (UILabel *)ZLRightNameLabel{
    if (!_ZLRightNameLabel) {
        ...
        _ZLRightNameLabel.textColor = [UIColor systemGreenColor];
...
- (UILabel *)ZLRightScoreLabel{
    if (!_ZLRightScoreLabel) {
        ...
        _ZLRightScoreLabel.textColor = [UIColor systemGreenColor];
...
- (UILabel *)ZLLeftNameLabel{
    if (!_ZLLeftNameLabel) {
        ...
        _ZLLeftNameLabel.textColor = [UIColor systemGreenColor];
...
- (UILabel *)ZLLeftScoreLabel{
    if (!_ZLLeftScoreLabel) {
        ...
        _ZLLeftScoreLabel.textColor = [UIColor systemGreenColor];
...
- (UIView *)ZLBottomLine{
    if (!_ZLBottomLine) {
        _ZLBottomLine = [[UIView alloc] init];
        _ZLBottomLine.backgroundColor = ZLH_Color(190, 194, 202, 1);
    }
    return _ZLBottomLine;
}
@end
