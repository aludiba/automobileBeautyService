//
//  ZLBasketballRecordTableViewCell.m
//  PocketScout
//
...
@interface ZLBasketballRecordTableViewCell()
...
@end
@implementation ZLBasketballRecordTableViewCell
...
- (UIView *)ZLBackView{
    if (!_ZLBackView) {
        ...
        _ZLBackView.backgroundColor = [UIColor greenColor];
