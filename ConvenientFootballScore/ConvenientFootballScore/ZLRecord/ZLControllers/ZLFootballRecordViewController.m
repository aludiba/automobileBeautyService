//
//  ZLFootballRecordViewController.m
...
@interface ZLFootballRecordViewController ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic, strong)NSMutableArray *ZLDataArray;
@property(nonatomic, strong)UITableView *ZLmainTable;
@end

@implementation ZLFootballRecordViewController
...
#pragma mark - actions
- (void)ZLDeleteData:(ZLScorecardModel *)model{
    AVObject *bmobObject = [AVObject objectWithoutDataWithClassName:@"ZLFootballScore"  objectId:model.ZLObjectId];
...
- (void)ZLLoadData{
    ...
    AVQuery *bquery = [AVQuery queryWithClassName:@"ZLFootballScore"];
        ...
        if (error) {
            ...
            if (array.count) {
                for (int i = (int)(array.count - 1); i > -1; i--) {
                    ...
                    ZLScorecardModel *model = [[ZLScorecardModel alloc] init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ZLScorecardModel *model = self.ZLDataArray[indexPath.row];
    ZLRecordTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ZLRecordTableViewCell" forIndexPath:indexPath];
    cell.ZLModel = model;
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
    __weak typeof(self) weakSelf = self;
    cell.ZLRecordDeleteB = ^(ZLRecordTableViewCell * _Nonnull cell) {
...
- (UITableView *)ZLmainTable{
    if (!_ZLmainTable) {
        ...
        [_ZLmainTable registerClass:[ZLRecordTableViewCell class] forCellReuseIdentifier:@"ZLRecordTableViewCell"];
