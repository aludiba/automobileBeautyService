//
//  GAFootballRecordViewController.m
...
@interface GAFootballRecordViewController ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic, strong)NSMutableArray *GADataArray;
@property(nonatomic, strong)UITableView *GAmainTable;
@end

@implementation GAFootballRecordViewController
...
#pragma mark - actions
- (void)GADeleteData:(GAScorecardModel *)model{
    AVObject *bmobObject = [AVObject objectWithoutDataWithClassName:@"GAFootballScore"  objectId:model.GAObjectId];
...
- (void)GALoadData{
    ...
    AVQuery *bquery = [AVQuery queryWithClassName:@"GAFootballScore"];
        ...
        if (error) {
            ...
            if (array.count) {
                for (int i = (int)(array.count - 1); i > -1; i--) {
                    ...
                    GAScorecardModel *model = [[GAScorecardModel alloc] init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    GAScorecardModel *model = self.GADataArray[indexPath.row];
    GARecordTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"GARecordTableViewCell" forIndexPath:indexPath];
    cell.GAModel = model;
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
    __weak typeof(self) weakSelf = self;
    cell.GARecordDeleteB = ^(GARecordTableViewCell * _Nonnull cell) {
...
- (UITableView *)GAmainTable{
    if (!_GAmainTable) {
        ...
        [_GAmainTable registerClass:[GARecordTableViewCell class] forCellReuseIdentifier:@"GARecordTableViewCell"];
