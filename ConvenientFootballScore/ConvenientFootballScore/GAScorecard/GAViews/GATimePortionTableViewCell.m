...
@interface GATimePortionTableViewCell()
...
@end
@implementation GATimePortionTableViewCell
...
- (UILabel *)GADisplayTimeLengthLabel{
    if (!_GADisplayTimeLengthLabel) {
        ...
        _GADisplayTimeLengthLabel.font = [UIFont boldSystemFontOfSize:25];
