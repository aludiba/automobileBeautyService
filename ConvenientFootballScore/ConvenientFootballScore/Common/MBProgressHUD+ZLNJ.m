...
@implementation MBProgressHUD (ZLNJ)
#pragma mark 显示信息
+ (void)ZLshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)ZLshowError:(NSString *)error toView:(UIView *)view{
    [self ZLshow:error icon:@"error.png" view:view];
}

+ (void)ZLshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self ZLshow:success icon:@"success.png" view:view];
}
...
{
    [self ZLshowSuccess:success toView:nil];
}

+ (void)ZLshowError:(NSString *)error
{
    [self ZLshowError:error toView:nil];
}

+ (void)ZLshowReminderText:(NSString *)reminderText {
    [self ZLshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self ZLshowMessage:message toView:nil];
}
