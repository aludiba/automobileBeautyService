...
@implementation MBProgressHUD (CFNJ)
#pragma mark 显示信息
+ (void)CFshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)CFshowError:(NSString *)error toView:(UIView *)view{
    [self CFshow:error icon:@"error.png" view:view];
}

+ (void)CFshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self CFshow:success icon:@"success.png" view:view];
}
...
{
    [self CFshowSuccess:success toView:nil];
}

+ (void)CFshowError:(NSString *)error
{
    [self CFshowError:error toView:nil];
}

+ (void)CFshowReminderText:(NSString *)reminderText {
    [self CFshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self CFshowMessage:message toView:nil];
}
