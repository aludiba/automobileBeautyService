...
@implementation MBProgressHUD (AFSNJ)
#pragma mark 显示信息
+ (void)AFSshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)AFSshowError:(NSString *)error toView:(UIView *)view{
    [self AFSshow:error icon:@"error.png" view:view];
}

+ (void)AFSshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self AFSshow:success icon:@"success.png" view:view];
}
...
{
    [self AFSshowSuccess:success toView:nil];
}

+ (void)AFSshowError:(NSString *)error
{
    [self AFSshowError:error toView:nil];
}

+ (void)AFSshowReminderText:(NSString *)reminderText {
    [self AFSshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self AFSshowMessage:message toView:nil];
}
