//
//  ZLScorecardFootballViewController.m
...
@interface ZLScorecardFootballViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation ZLScorecardFootballViewController
+ (ZLScorecardFootballViewController *)shareInstance{
    static ZLScorecardFootballViewController *client;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        client = [[ZLScorecardFootballViewController allocWithZone:NULL] init];
    });
    return client;
}
- (void)viewDidLoad {
...
- (void)ZLsaveAction{
    ...
    AVObject *diary = [AVObject objectWithClassName:@"ZLFootballScore"];
