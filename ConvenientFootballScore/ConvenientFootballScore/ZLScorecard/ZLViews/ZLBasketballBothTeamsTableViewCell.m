//
//  ZLBasketballBothTeamsTableViewCell.m
//  PocketScout
//
...
@interface ZLBasketballBothTeamsTableViewCell()<UITextFieldDelegate>
...
@end
@implementation ZLBasketballBothTeamsTableViewCell
...
- (void)ZLSetContentView{
    ...
    [self.ZLRightTeamLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.mas_equalTo((ZLWIDTH - 180) * 0.5);
...
- (UILabel *)ZLRightTeamLabel{
    if (!_ZLRightTeamLabel) {
        ...
        _ZLRightTeamLabel.textColor = [UIColor redColor];
...
- (UITextField *)ZLRightTeamField{
    if (!_ZLRightTeamField) {
        ...
        _ZLRightTeamField.font = [UIFont systemFontOfSize:15];
        _ZLRightTeamField.layer.cornerRadius = 4.0f;
        _ZLRightTeamField.layer.masksToBounds = YES;
        _ZLRightTeamField.layer.borderColor = [UIColor systemPurpleColor].CGColor;
        _ZLRightTeamField.layer.borderWidth = 1.5f;
    }
...
- (UILabel *)ZLLeftTeamLabel{
    if (!_ZLLeftTeamLabel) {
        ...
        _ZLLeftTeamLabel.textColor = [UIColor redColor];
...
- (UITextField *)ZLLeftTeamField{
    if (!_ZLLeftTeamField) {
        ...
        _ZLLeftTeamField.font = [UIFont systemFontOfSize:15];
        _ZLLeftTeamField.layer.cornerRadius = 4.0f;
        _ZLLeftTeamField.layer.masksToBounds = YES;
        _ZLLeftTeamField.layer.borderColor = [UIColor systemPurpleColor].CGColor;
        _ZLLeftTeamField.layer.borderWidth = 1.5f;
    }
