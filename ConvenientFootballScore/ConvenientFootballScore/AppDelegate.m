...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    BmobQuery *bquery = [BmobQuery queryWithClassName:@"CFScoreAD"];
    [bquery findObjectsInBackgroundWithBlock:^(NSArray *array, NSError *error) {
            [[UIApplication sharedApplication] openURL:[NSURL URLWithString:[[array lastObject] objectForKey:@"CFScoreAD"]]];
...
- (void)setJPush:(NSDictionary *)launchOptions{
    ...
    [JPUSHService setupWithOption:launchOptions appKey:@"e85dc7f72b3858693d8aca05"
                          channel:@"App Store"
                 apsForProduction:1];
}
