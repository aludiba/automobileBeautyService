//
//  stbaAddActivitiesEditorTableViewCell.m
...
@interface stbaAddActivitiesEditorTableViewCell()<UITextViewDelegate>
@property(nonatomic, strong)UILabel *titleLbl;
@property(nonatomic, strong)UITextView *contentField;
@property(nonatomic, strong)UILabel *placeLbl;
@end
@implementation stbaAddActivitiesEditorTableViewCell
