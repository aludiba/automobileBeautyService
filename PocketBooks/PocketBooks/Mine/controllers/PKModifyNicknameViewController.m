//
//  PKModifyNicknameViewController.m
//  PocketBooks
//
...
@interface PKModifyNicknameViewController ()<UITextFieldDelegate>
@property(nonatomic, strong)UITextField *confirmNickNameTextField;
@property(nonatomic, strong)UIButton *sureButton;
@end

@implementation PKModifyNicknameViewController
...
- (void)btnClick:(UIButton *)sender{
    ...
    [bUser updateInBackgroundWithResultBlock:^(BOOL isSuccessful, NSError *error) {
        if (isSuccessful) {
            [MBProgressHUD PKshowReminderText:NSLocalizedString(@"更新成功", nil)];
