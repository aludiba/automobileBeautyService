...
- (void)setModel:(PKSetViewModel *)model{
    _model = model;
...
- (UIImageView *)arrowImgView{
    if (!_arrowImgView) {
        _arrowImgView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"PK_arrow_right"]];
    }
...
- (UIView *)line{
    if (!_line) {
        ...
        _line.backgroundColor = PKH_Color(216, 218, 219, 1);
    }
    return _line;
}
@end
