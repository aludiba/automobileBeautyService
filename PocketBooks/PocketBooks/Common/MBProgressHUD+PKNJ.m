...
@implementation MBProgressHUD (PKNJ)
#pragma mark 显示信息
+ (void)PKshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)PKshowError:(NSString *)error toView:(UIView *)view{
    [self PKshow:error icon:@"error.png" view:view];
}

+ (void)PKshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self PKshow:success icon:@"success.png" view:view];
}
...
{
    [self PKshowSuccess:success toView:nil];
}

+ (void)PKshowError:(NSString *)error
{
    [self PKshowError:error toView:nil];
}

+ (void)PKshowReminderText:(NSString *)reminderText {
    [self PKshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self PKshowMessage:message toView:nil];
}
