...
@implementation MBProgressHUD (EANJ)
#pragma mark 显示信息
+ (void)EAshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)EAshowError:(NSString *)error toView:(UIView *)view{
    [self EAshow:error icon:@"error.png" view:view];
}

+ (void)EAshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self EAshow:success icon:@"success.png" view:view];
}
...
{
    [self EAshowSuccess:success toView:nil];
}

+ (void)EAshowError:(NSString *)error
{
    [self EAshowError:error toView:nil];
}

+ (void)EAshowReminderText:(NSString *)reminderText {
    [self EAshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self EAshowMessage:message toView:nil];
}
