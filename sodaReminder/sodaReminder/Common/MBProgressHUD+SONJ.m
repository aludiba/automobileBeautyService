...
@implementation MBProgressHUD (SONJ)
#pragma mark 显示信息
+ (void)SOshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)SOshowError:(NSString *)error toView:(UIView *)view{
    [self SOshow:error icon:@"error.png" view:view];
}

+ (void)SOshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self SOshow:success icon:@"success.png" view:view];
}
...
{
    [self SOshowSuccess:success toView:nil];
}

+ (void)SOshowError:(NSString *)error
{
    [self SOshowError:error toView:nil];
}

+ (void)SOshowReminderText:(NSString *)reminderText {
    [self SOshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self SOshowMessage:message toView:nil];
}
