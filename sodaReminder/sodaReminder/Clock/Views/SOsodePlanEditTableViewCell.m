...
@interface SOsodePlanEditTableViewCell()<UITextFieldDelegate>
@property(nonatomic, strong)UILabel *titleLbl;
@property(nonatomic, strong)UITextField *editText;
@property(nonatomic, strong)UILabel *unitLabel;
@property(nonatomic, strong)UIView *line;
@end
@implementation SOsodePlanEditTableViewCell
...
- (void)setModel:(SOsodePlanModel *)model{
    ...
    self.unitLabel.text = _model.SOunit;
...
- (BOOL)textFieldShouldBeginEditing:(UITextField *)textField{
    if (textField.text.length) {
        self.model.SOcontent = textField.text;
    }else{
        self.editText.placeholder = _model.SOdefaultString;
    }
    return YES;
