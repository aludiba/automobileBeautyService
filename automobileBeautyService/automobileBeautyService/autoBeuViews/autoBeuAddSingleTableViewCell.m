//
//  auto4sAddSingleTableViewCell.m
...
@interface autoBeuAddSingleTableViewCell()<UITextViewDelegate>
...
@end
@implementation autoBeuAddSingleTableViewCell
...
- (void)textViewDidChange:(UITextView *)textView {
    ...
    if (self.autoBeuAddSingleblock) {
        self.autoBeuAddSingleblock(self);
    }
}
