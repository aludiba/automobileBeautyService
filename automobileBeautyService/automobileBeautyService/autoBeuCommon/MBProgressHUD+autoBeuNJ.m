...
@implementation MBProgressHUD (autoBeuNJ)
#pragma mark 显示信息
+ (void)autoBeushow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)autoBeushowError:(NSString *)error toView:(UIView *)view{
    [self autoBeushow:error icon:@"error.png" view:view];
}

+ (void)autoBeushowSuccess:(NSString *)success toView:(UIView *)view
{
    [self autoBeushow:success icon:@"success.png" view:view];
}
...
{
    [self autoBeushowSuccess:success toView:nil];
}

+ (void)autoBeushowError:(NSString *)error
{
    [self autoBeushowError:error toView:nil];
}

+ (void)autoBeushowReminderText:(NSString *)reminderText {
    [self autoBeushowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self autoBeushowMessage:message toView:nil];
}
...
+ (void)autoBeuhideHUD
{
    [self autoBeuhideHUDForView:nil];
}
@end
