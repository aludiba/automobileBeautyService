...
@implementation MBProgressHUD (GHNJ)
#pragma mark 显示信息
+ (void)GHshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)GHshowError:(NSString *)error toView:(UIView *)view{
    [self GHshow:error icon:@"error.png" view:view];
}

+ (void)GHshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self GHshow:success icon:@"success.png" view:view];
}
...
{
    [self GHshowSuccess:success toView:nil];
}

+ (void)GHshowError:(NSString *)error
{
    [self GHshowError:error toView:nil];
}

+ (void)GHshowReminderText:(NSString *)reminderText {
    [self GHshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self GHshowMessage:message toView:nil];
}
