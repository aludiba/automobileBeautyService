...
@implementation MBProgressHUD (PHNJ)
#pragma mark 显示信息
+ (void)PHshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)PHshowError:(NSString *)error toView:(UIView *)view{
    [self PHshow:error icon:@"error.png" view:view];
}

+ (void)PHshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self PHshow:success icon:@"success.png" view:view];
}
...
{
    [self PHshowSuccess:success toView:nil];
}

+ (void)PHshowError:(NSString *)error
{
    [self PHshowError:error toView:nil];
}

+ (void)PHshowReminderText:(NSString *)reminderText {
    [self PHshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self PHshowMessage:message toView:nil];
}
