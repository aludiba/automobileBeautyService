...
@interface GAgamePlanSaveTableViewCell()
@property(nonatomic, strong)UIButton *saveButton;//保存按钮
@end
@implementation GAgamePlanSaveTableViewCell
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        self.contentView.backgroundColor = GAH_Color(244, 245, 246, 1);
...
- (void)btnClick{
    if (self.GAgamePlanSaveB) {
        self.GAgamePlanSaveB(self);
    }
}
#pragma mark - 属性懒加载
- (UIButton *)saveButton{
