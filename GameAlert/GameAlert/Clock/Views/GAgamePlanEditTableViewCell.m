...
@interface GAgamePlanEditTableViewCell()<UITextFieldDelegate>
...
- (void)setModel:(GAgamePlanModel *)model{
    ...
    self.unitLabel.text = _model.GAunit;
...
- (BOOL)textFieldShouldBeginEditing:(UITextField *)textField{
    if (textField.text.length) {
        self.model.GAcontent = textField.text;
    }else{
        self.editText.placeholder = _model.GAdefaultString;
    }
    return YES;
