...
@implementation MBProgressHUD (GANJ)
#pragma mark 显示信息
+ (void)GAshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)GAshowError:(NSString *)error toView:(UIView *)view{
    [self GAshow:error icon:@"error.png" view:view];
}

+ (void)GAshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self GAshow:success icon:@"success.png" view:view];
}
...
{
    [self GAshowSuccess:success toView:nil];
}

+ (void)GAshowError:(NSString *)error
{
    [self GAshowError:error toView:nil];
}

+ (void)GAshowReminderText:(NSString *)reminderText {
    [self GAshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self GAshowMessage:message toView:nil];
}
