...
@implementation MBProgressHUD (AFNJ)
#pragma mark 显示信息
+ (void)AFshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)AFshowError:(NSString *)error toView:(UIView *)view{
    [self AFshow:error icon:@"error.png" view:view];
}

+ (void)AFshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self AFshow:success icon:@"success.png" view:view];
}
...
{
    [self AFshowSuccess:success toView:nil];
}

+ (void)AFshowError:(NSString *)error
{
    [self AFshowError:error toView:nil];
}

+ (void)AFshowReminderText:(NSString *)reminderText {
    [self AFshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self AFshowMessage:message toView:nil];
}
