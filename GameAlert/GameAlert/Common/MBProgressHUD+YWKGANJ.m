...
@implementation MBProgressHUD (YWKGANJ)
#pragma mark 显示信息
+ (void)YWKGAshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)YWKGAshowError:(NSString *)error toView:(UIView *)view{
    [self YWKGAshow:error icon:@"error.png" view:view];
}

+ (void)YWKGAshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self YWKGAshow:success icon:@"success.png" view:view];
}
...
{
    [self YWKGAshowSuccess:success toView:nil];
}

+ (void)YWKGAshowError:(NSString *)error
{
    [self YWKGAshowError:error toView:nil];
}

+ (void)YWKGAshowReminderText:(NSString *)reminderText {
    [self YWKGAshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self YWKGAshowMessage:message toView:nil];
}
