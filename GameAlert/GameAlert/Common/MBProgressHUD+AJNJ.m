...
@implementation MBProgressHUD (AJNJ)
#pragma mark 显示信息
+ (void)AJshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)AJshowError:(NSString *)error toView:(UIView *)view{
    [self AJshow:error icon:@"error.png" view:view];
}

+ (void)AJshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self AJshow:success icon:@"success.png" view:view];
}
...
{
    [self AJshowSuccess:success toView:nil];
}

+ (void)AJshowError:(NSString *)error
{
    [self AJshowError:error toView:nil];
}

+ (void)AJshowReminderText:(NSString *)reminderText {
    [self AJshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self AJshowMessage:message toView:nil];
}
