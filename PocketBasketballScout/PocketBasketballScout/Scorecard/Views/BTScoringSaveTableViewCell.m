...
- (UIButton *)BTSaveButton{
    if (!_BTSaveButton) {
        ...
        [_BTSaveButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        _BTSaveButton.backgroundColor = [UIColor systemBlueColor];
        ...
        _BTSaveButton.layer.borderColor = [UIColor systemGreenColor].CGColor;
