...
@implementation MBProgressHUD (CBSNJ)
#pragma mark 显示信息
+ (void)CBSshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)CBSshowError:(NSString *)error toView:(UIView *)view{
    [self CBSshow:error icon:@"error.png" view:view];
}

+ (void)CBSshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self CBSshow:success icon:@"success.png" view:view];
}
...
{
    [self CBSshowSuccess:success toView:nil];
}

+ (void)CBSshowError:(NSString *)error
{
    [self CBSshowError:error toView:nil];
}

+ (void)CBSshowReminderText:(NSString *)reminderText {
    [self CBSshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self CBSshowMessage:message toView:nil];
}
