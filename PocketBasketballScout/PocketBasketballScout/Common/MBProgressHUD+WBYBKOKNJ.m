...
@implementation MBProgressHUD (WBYBKOKNJ)
#pragma mark 显示信息
+ (void)WBYBKOKshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)WBYBKOKshowError:(NSString *)error toView:(UIView *)view{
    [self WBYBKOKshow:error icon:@"error.png" view:view];
}

+ (void)WBYBKOKshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self WBYBKOKshow:success icon:@"success.png" view:view];
}
...
{
    [self WBYBKOKshowSuccess:success toView:nil];
}

+ (void)WBYBKOKshowError:(NSString *)error
{
    [self WBYBKOKshowError:error toView:nil];
}

+ (void)WBYBKOKshowReminderText:(NSString *)reminderText {
    [self WBYBKOKshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self WBYBKOKshowMessage:message toView:nil];
}
...
+ (void)WBYBKOKhideHUD
{
    [self WBYBKOKhideHUDForView:nil];
}
@end
