...
@implementation MBProgressHUD (ADNJ)
#pragma mark 显示信息
+ (void)ADshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)ADshowError:(NSString *)error toView:(UIView *)view{
    [self ADshow:error icon:@"error.png" view:view];
}

+ (void)ADshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self ADshow:success icon:@"success.png" view:view];
}
...
{
    [self ADshowSuccess:success toView:nil];
}

+ (void)ADshowError:(NSString *)error
{
    [self ADshowError:error toView:nil];
}

+ (void)ADshowReminderText:(NSString *)reminderText {
    [self ADshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self ADshowMessage:message toView:nil];
}
