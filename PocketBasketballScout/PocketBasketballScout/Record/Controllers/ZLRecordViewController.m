...
@interface ZLRecordViewController ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)ZLDeleteData:(ZLScorecardModel *)model{
    AVObject *bmobObject = [AVObject objectWithoutDataWithClassName:@"ZLScore"  objectId:model.ZLObjectId];
...
- (void)ZLLoadData{
    AVQuery *bquery = [AVQuery queryWithClassName:@"ZLScore"];
...
- (UITableView *)ZLmainTable{
    if (!_ZLmainTable) {
        ...
        _ZLmainTable.backgroundColor = [UIColor cyanColor];
