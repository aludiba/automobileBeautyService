...
- (void)CBSDeleteData:(CBSScorecardModel *)model{
    BmobObject *bmobObject = [BmobObject objectWithoutDataWithClassName:@"CBSScore"  objectId:model.CBSObjectId];
...
- (void)CBSLoadData{
    BmobQuery *bquery = [BmobQuery queryWithClassName:@"CBSScore"];
