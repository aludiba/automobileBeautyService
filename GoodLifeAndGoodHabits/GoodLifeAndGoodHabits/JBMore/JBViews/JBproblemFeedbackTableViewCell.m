//
//  JBproblemFeedbackTableViewCell.m
...
@interface JBproblemFeedbackTableViewCell()<UITextViewDelegate>
...
@end
@implementation JBproblemFeedbackTableViewCell
...
//            make.top.equalTo(self.JBeditableView.mas_bottom).offset(11.5);
...
- (void)setJBViewModel:(JBCargoAddViewModel *)JBViewModel{
    _JBViewModel = JBViewModel;
    if ([_JBViewModel.JBTitle length]){
        self.JBtitleLbl.text = _JBViewModel.JBTitle;
    }else{
        self.JBtitleLbl.text = @"";
    }
...
- (UILabel *)JBtitleLbl{
    if (!_JBtitleLbl) {
        ...
        _JBtitleLbl.textColor = [UIColor blueColor];
    }
    return _JBtitleLbl;
}
- (UILabel *)JBhiddenLbl{
...
//        _JBline.backgroundColor = JBH_Color(226, 228, 232, 1);
//    }
//    return _JBline;
//}
@end
