...
@implementation MBProgressHUD (JBNJ)
#pragma mark 显示信息
+ (void)JBshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)JBshowError:(NSString *)error toView:(UIView *)view{
    [self JBshow:error icon:@"error.png" view:view];
}

+ (void)JBshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self JBshow:success icon:@"success.png" view:view];
}
...
{
    [self JBshowSuccess:success toView:nil];
}

+ (void)JBshowError:(NSString *)error
{
    [self JBshowError:error toView:nil];
}

+ (void)JBshowReminderText:(NSString *)reminderText {
    [self JBshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self JBshowMessage:message toView:nil];
}
