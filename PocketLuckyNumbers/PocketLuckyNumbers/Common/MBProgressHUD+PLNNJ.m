...
@implementation MBProgressHUD (PLNNJ)
#pragma mark 显示信息
+ (void)PLNshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)PLNshowError:(NSString *)error toView:(UIView *)view{
    [self PLNshow:error icon:@"error.png" view:view];
}

+ (void)PLNshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self PLNshow:success icon:@"success.png" view:view];
}
...
{
    [self PLNshowSuccess:success toView:nil];
}

+ (void)PLNshowError:(NSString *)error
{
    [self PLNshowError:error toView:nil];
}

+ (void)PLNshowReminderText:(NSString *)reminderText {
    [self PLNshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self PLNshowMessage:message toView:nil];
}
