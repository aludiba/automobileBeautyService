//
//  QSsmokingPlanEditTableViewCell.m
//  wineAwake
//
...
@interface QSsmokingPlanEditTableViewCell()<UITextFieldDelegate>
@property(nonatomic, strong)UILabel *titleLbl;
@property(nonatomic, strong)UITextField *editText;
@property(nonatomic, strong)UILabel *unitLabel;
@property(nonatomic, strong)UIView *line;
@end
@implementation QSsmokingPlanEditTableViewCell
...
- (void)setModel:(QSsmokingPlanModel *)model{
    ...
    self.unitLabel.text = _model.QSunit;
...
- (BOOL)textFieldShouldBeginEditing:(UITextField *)textField{
    if (textField.text.length) {
        self.model.QScontent = textField.text;
    }else{
        self.editText.placeholder = _model.QSdefaultString;
    }
    return YES;
