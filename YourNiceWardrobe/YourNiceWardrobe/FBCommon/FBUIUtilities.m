...
@implementation FBUIUtilities

+ (NSString *)FBformattedStringFromTimeString:(NSString *)originalString originalFormat:(NSString *)originalFormat targetFormat:(NSString *)targetFormat {
...
+ (NSString *)FBnonnullStringForString:(NSString *)originalString withPlaceholder:(NSString *)placeholder {
...
+ (NSString *)FBfilterHTMLTag:(NSString *)originalHTMLString {
...
+ (NSString *)FBunescapedHTMLString:(NSString *)originalHTMLString {
