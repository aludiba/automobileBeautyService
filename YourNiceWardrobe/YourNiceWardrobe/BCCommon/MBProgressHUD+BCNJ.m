...
@implementation MBProgressHUD (BCNJ)
#pragma mark 显示信息
+ (void)BCshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)BCshowError:(NSString *)error toView:(UIView *)view{
    [self BCshow:error icon:@"error.png" view:view];
}

+ (void)BCshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self BCshow:success icon:@"success.png" view:view];
}
...
{
    [self BCshowSuccess:success toView:nil];
}

+ (void)BCshowError:(NSString *)error
{
    [self BCshowError:error toView:nil];
}

+ (void)BCshowReminderText:(NSString *)reminderText {
    [self BCshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self BCshowMessage:message toView:nil];
}
