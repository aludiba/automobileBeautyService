...
+ (NSString *)BCformattedStringFromTimeString:(NSString *)originalString originalFormat:(NSString *)originalFormat targetFormat:(NSString *)targetFormat {
...
+ (NSString *)BCnonnullStringForString:(NSString *)originalString withPlaceholder:(NSString *)placeholder {
...
+ (NSString *)BCfilterHTMLTag:(NSString *)originalHTMLString {
...
+ (NSString *)BCunescapedHTMLString:(NSString *)originalHTMLString {
