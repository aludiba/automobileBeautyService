...
@implementation MBProgressHUD (KTNJ)
#pragma mark 显示信息
+ (void)KTshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)KTshowError:(NSString *)error toView:(UIView *)view{
    [self KTshow:error icon:@"error.png" view:view];
}

+ (void)KTshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self KTshow:success icon:@"success.png" view:view];
}
...
{
    [self KTshowSuccess:success toView:nil];
}

+ (void)KTshowError:(NSString *)error
{
    [self KTshowError:error toView:nil];
}

+ (void)KTshowReminderText:(NSString *)reminderText {
    [self KTshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self KTshowMessage:message toView:nil];
}
