...
@implementation MBProgressHUD (KANJ)
#pragma mark 显示信息
+ (void)KAshow:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)KAshowError:(NSString *)error toView:(UIView *)view{
    [self KAshow:error icon:@"error.png" view:view];
}

+ (void)KAshowSuccess:(NSString *)success toView:(UIView *)view
{
    [self KAshow:success icon:@"success.png" view:view];
}
...
{
    [self KAshowSuccess:success toView:nil];
}

+ (void)KAshowError:(NSString *)error
{
    [self KAshowError:error toView:nil];
}

+ (void)KAshowReminderText:(NSString *)reminderText {
    [self KAshowReminderText:reminderText toView:nil];
}

+ (MBProgressHUD *)auto4BeushowMessage:(NSString *)message
{
    return [self KAshowMessage:message toView:nil];
}
