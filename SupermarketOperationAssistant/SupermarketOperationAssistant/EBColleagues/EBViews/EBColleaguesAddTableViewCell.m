//
//  EBColleaguesAddTableViewCell.m
...
@interface EBColleaguesAddTableViewCell()<UITextViewDelegate>
...
@end
@implementation EBColleaguesAddTableViewCell
...
- (void)setEBViewmodel:(EBColleaguesAddModel *)EBViewmodel{
