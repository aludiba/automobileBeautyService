...
@implementation EBUIUtilities

+ (NSString *)EBformattedStringFromTimeString:(NSString *)originalString originalFormat:(NSString *)originalFormat targetFormat:(NSString *)targetFormat {
...
+ (NSString *)EBnonnullStringForString:(NSString *)originalString withPlaceholder:(NSString *)placeholder {
...
+ (NSString *)EBfilterHTMLTag:(NSString *)originalHTMLString {
...
+ (NSString *)EBunescapedHTMLString:(NSString *)originalHTMLString {
